...
from infrastructure.views.token import ThrottledTokenObtainPairView, ThrottledTokenRefreshView
...
urlpatterns = [
    ...
    path("auth/token/refresh/", ThrottledTokenRefreshView.as_view(), name="auth-token-refresh"),
